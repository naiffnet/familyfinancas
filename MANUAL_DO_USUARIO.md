...
- [1. Primeiros Passos & Acesso](#-1-primeiros-passos--acesso)
- [2. Contas Bancárias, Carteiras & Cartões Benefício](#-2-contas-bancárias-carteiras--cartões-benefício)
- [3. Cartões de Crédito: Faturas, Antecipação, Rotativo & Estornos](#-3-cartões-de-crédito-faturas-antecipação-rotativo--estornos)
- [4. Lançamentos & Leitura de Notas Fiscais (QR Code)](#-4-lançamentos--leitura-de-notas-fiscais-qr-code)
- [5. Juros, Multas, Descontos & Prorrogação em Feriados](#-5-juros-multas-descontos--prorrogação-em-feriados)
...
## 🌟 1. Primeiros Passos & Acesso

### 1.1 Criando sua Família e Primeiro Usuário
...
## 💳 3. Cartões de Crédito: Faturas, Antecipação, Rotativo & Estornos
...
## 📊 8. Dashboard, Visões & Kanban em 3 Colunas

### 8.1 Os 3 Modos de Visualização
- **Executivo:** Blocos consolidados de patrimônio, saldos e faturas.
- **Sub-Abas:** Navegação setorizada.
- **Cockpit Integrado:** Painel de alta densidade em tela única.
